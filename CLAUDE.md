...
The DSL supports: Kafka, HTTP servers, SQL databases (PostgreSQL/MySQL/Oracle with JOOQ), MongoDB, S3 and AWS API Gateway (via LocalStack), Hazelcast, Avro/Protobuf schemas.
