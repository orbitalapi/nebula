...
export function HeadMetaTags({title = "Nebula - Scriptable test environments"}) {
  return (
    <Head>
      <meta
        key="twitter:title"
...
export function SectionHeading({className = '', ...props}) {
  return <h2 className={`mt-8 font-semibold font-brand text-nebula-brand-500 text-center text-md ${className}`} {...props} />
}
